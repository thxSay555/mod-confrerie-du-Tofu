...
public class Eliatrope_hat extends ModelBase {
	...
	private final ModelRenderer 1er;
	private final ModelRenderer 2eme;
	private final ModelRenderer 3eme;
	...
	public Eliatrope_hat() {
		...
		1er = new ModelRenderer(this);
		1er.setRotationPoint(0.0283F, -2.3129F, 0.1378F);
		chapeau_eliatrope.addChild(1er);
		setRotationAngle(1er, -0.9163F, 0.0F, 0.0F);
		1er.cubeList.add(new ModelBox(1er, 0, 0, -3.3602F, -0.1542F, -1.4638F, 7, 7, 7, 0.0F, false));

		2eme = new ModelRenderer(this);
		2eme.setRotationPoint(0.1857F, 1.6867F, 5.4473F);
		1er.addChild(2eme);
		setRotationAngle(2eme, -0.5236F, 0.0F, 0.0F);
		2eme.cubeList.add(new ModelBox(2eme, 0, 18, -3.6191F, -1.8351F, -0.9149F, 7, 7, 7, 0.0F, false));

		3eme = new ModelRenderer(this);
		3eme.setRotationPoint(-0.2936F, 1.7124F, 4.3636F);
		2eme.addChild(3eme);
		setRotationAngle(3eme, -0.0436F, 0.0F, 0.0F);
		

		cube_r1 = new ModelRenderer(this);
		cube_r1.setRotationPoint(-0.0086F, -0.6375F, 3.9409F);
		3eme.addChild(cube_r1);
		setRotationAngle(cube_r1, 0.2182F, 0.0F, 0.0F);
		cube_r1.cubeList.add(new ModelBox(cube_r1, 0, 42, -2.8573F, -3.0227F, -3.0916F, 6, 6, 6, 0.0F, false));

		froufrou = new ModelRenderer(this);
		froufrou.setRotationPoint(0.0F, -1.5549F, 6.9084F);
		3eme.addChild(froufrou);
		setRotationAngle(froufrou, 0.2618F, 0.0F, 0.0F);
		

		cube_r2 = new ModelRenderer(this);
		cube_r2.setRotationPoint(0.0729F, 0.1566F, -0.5182F);
		froufrou.addChild(cube_r2);
		setRotationAngle(cube_r2, 1.5708F, 0.0F, 0.0F);
		cube_r2.cubeList.add(new ModelBox(cube_r2, 44, 34, -2.2673F, 0.2091F, -2.5698F, 5, 5, 5, 0.0F, false));
